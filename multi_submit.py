...
parser.add_argument('--year', '-y', choices=['UL16','UL17','UL18'], default='UL17', help='specify the year of the data/mc nano being run')
args = parser.parse_args()

griduser_id = (subprocess.check_output("whoami").decode('utf-8')).strip()
full_output_path = '/cms/' + griduser_id + '/eos/twoprong/sanity_plots/atto/' + args.tag # for atto only
...
if args.mode == 'atto':
  ...
  locs['egamma17b'] = '/cms/twoprong/chiarito/nano/egamma/egamma_17b/fv1p5-9-5ce1_bv1p2-0-1531/'
  locs['egamma17c'] = '/cms/twoprong/chiarito/nano/egamma/egamma_17c/fv1p6-1-f947_bv1p3-0-539a/'
  locs['egamma17d'] = '/cms/twoprong/chiarito/nano/egamma/egamma_17d/fv1p6-1-f947_bv1p3-0-539a/'
  locs['egamma17e'] = '/cms/twoprong/chiarito/nano/egamma/egamma_17e/'
...
if args.mode == 'atto':
    if args.year == 'UL18':
        ...
        add_job(tag='egamma17b', options='--data --datasetname=egamma17b', loc=locs['egamma17b'])
        add_job(tag='egamma17c', options='--data --datasetname=egamma17c', loc=locs['egamma17c'])
