...
python CMSSW_10_6_20/src/PhysicsTools/NanoAODTools/python/fmk_atto/nano_postproc.py infiles_$3.dat . --drop ${11} --filter="$8" -n=-1 --$5 --dataset=${9} --proc=$3 --outfile=$2 --report=report_$3.txt --analyzer=${16} --lumimask=${18}
if [ ${16} == "main" ]; then
