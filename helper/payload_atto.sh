...
python CMSSW_10_6_20/src/PhysicsTools/NanoAODTools/python/fmk_atto/nano_postproc.py infiles_$3.dat . --drop atto_branch_selection.txt --filter="$8" --add_recophi HPID -n=-1 --$5 --dataset=${9} --proc=$3 --outfile=$2 --report=report_$3.txt
