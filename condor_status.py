...
parser.add_argument("-r", "--report", default=False, action="store_true",help="also check stdout report on directory")
...
if args.report:
  os.system('./parse_stdout.py '+output_area)
